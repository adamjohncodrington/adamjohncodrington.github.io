...
export const EXOTICA_1: PoleTricksVideo = {
...
export const EXOTICA_4: PoleTricksVideo = {
  studio: STUDIOS.EXOTICA_BERMONDSEY,
...
export const MY_GRAVITY: PoleTricksVideo = {
...
export const EXOTICA_2: PoleTricksVideo = {
  studio: STUDIOS.EXOTICA_BERMONDSEY,
...
export const EXOTICA_3: PoleTricksVideo = {
  studio: STUDIOS.EXOTICA_BERMONDSEY,
...
export const TIGRA_GST: PoleTricksVideo = {
