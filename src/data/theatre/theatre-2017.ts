...
export const UGLY_LIES_THE_BONE: ITheatreVisit = {
...
export const KINKY_BOOTS: ITheatreVisit = {
...
export const MATILDA: ITheatreVisit = {
  play: PLAYS.MATILDA,
...
export const YOUNG_MARX: ITheatreVisit = {
...
export const FERRYMAM: ITheatreVisit = {
