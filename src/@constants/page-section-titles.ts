...
export const IMPROV: string = "Improvisation";
...
export const SAUCES: string = "Sauces";
export const SIDES: string = "Sides";
export const SWEETS: string = "Sweets";

// Theatre
export const ACTORS: string = "Actors";
export const PLAYS: string = "Plays";
export const THEATRES: string = "Theatres";
