...
export const ALLIE_X_SUPER_SUNSET: IVinyl = {
  ...
  title: "Super Sunset",
  artwork: PHOTOS.ALBUMS.ALLIE_X_SUPER_SUNSET,
...
export const BEYONCE_LEMONADE: IVinyl = {
...
export const TOURIST_U: IVinyl = {
  musician: MUSICIANS.TOURIST,
  appleMusicId: "u/1086160489",
  title: "U",
  artwork: PHOTOS.ALBUMS.TOURIST_U,
  year: 2016
};
...
export const MUNA_ABOUT_U: IVinyl = {
  ...
  title: "About U",
  artwork: PHOTOS.ALBUMS.MUNA_ABOUT_U,
...
export const JON_HOPKINS_SINGULARITY: IVinyl = {
...
export const SOPHIE_OOEPUI: IVinyl = {
...
export const RYN_WEAVER_FOOL: IVinyl = {
...
export const RIHANNA_RATED_R: IVinyl = {
...
export const KATY_PERRY_ONE_OF_THE_BOYS: IVinyl = {
...
export const PANIC_AT_THE_DISCO_AFYCSO: IVinyl = {
...
export const NATALIA_KILLS_PERFECTIONIST: IVinyl = {
