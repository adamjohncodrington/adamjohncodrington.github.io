export const MUSICIANS: IMusicians = {
  ...
  AMY_WINEHOUSE: { name: "Amy Winehouse", noLongerExists: true },
  ...
  NATALIA_KILLS: { name: "Natalia Kills", noLongerExists: true },
  NATASH_MORETONA_BEDINGFIELD: { name: "Natasha Bedingfield" },
  NAVVY: { name: "Navvy" },
  ...
  SASH_MORETONA_SLOAN: { name: "Sasha Sloan" },
  SBTRKT: { name: "SBTRKT" },
  SEEB: { name: "Seeb" },
